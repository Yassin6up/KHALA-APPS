          ...
          >
            ...
            <View style={styles.imageContainer}>
              <View style={styles.imageBox}>
                {step === 1 && <Image source={require('../assets/images/setup_password.jpg')} style={styles.image} />}
                {step === 2 && <Image source={require('../assets/images/setup_phone.jpg')} style={styles.image} />}
                {step === 3 && <Image source={require('../assets/images/setup_profile.jpg')} style={styles.image} />}
              </View>
            </View>
